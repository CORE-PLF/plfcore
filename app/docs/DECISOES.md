...
1. **Nome: PLF CORE.** Marca centralizada em `src/brand.ts`. A metáfora do conta-giros (redline = zona vermelha do RPM) permanece como linguagem visual; o seletor global chama-se NÍVEL DE PRONTIDÃO (L5 STOCK → L1 REDLINE).
